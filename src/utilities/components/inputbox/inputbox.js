...
const InputBox = ({
	...
	return (
		<div className="atgb__devices_inputs">
			...
			<div className="atgb__inputs_group">
				{device === 'desktop' && (
					<div className="atgb_input__controls">
						<NumberControl
							label={__('Top', 'advanced-team-blocks')}
						...
						/>
						<NumberControl
							label={__('Right', 'advanced-team-blocks')}
						...
						/>
						<NumberControl
							label={__('Bottom', 'advanced-team-blocks')}
						...
						/>
						<NumberControl
							label={__('Left', 'advanced-team-blocks')}
						...
						<button
							className={`atgb__linked_settings ${
								dLinked ? 'active' : ''
							}`}
							onClick={() => {
								setAttributes({
