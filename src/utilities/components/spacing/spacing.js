			...
			<div className="afgb__items spacing">
				{device === 'desktop' && (
					<NumberControl
						...
						onChange={(value) =>
							setAttributes({ [deskAttr]: value })
						}
						shiftStep={10}
						value={deskValue}
						label={__('Desktop (px)', 'advanced-team-blocks')}
						labelPosition="side"
					/>
				)}
				{device === 'tablet' && (
					<NumberControl
						isShiftStepEnabled={true}
						onChange={(value) =>
							setAttributes({ [tabAttr]: value })
						}
						shiftStep={10}
						value={tabValue}
						label={__('Tablet (px)', 'advanced-team-blocks')}
						labelPosition="side"
					/>
				)}
				{device === 'mobile' && (
					<NumberControl
						isShiftStepEnabled={true}
						onChange={(value) =>
							setAttributes({ [mobAttr]: value })
						}
						shiftStep={10}
						value={mobValue}
						label={__('Mobile (px)', 'advanced-team-blocks')}
						labelPosition="side"
					/>
				)}
			</div>
